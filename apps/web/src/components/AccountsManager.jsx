      ...
      <div className="mt-5 grid gap-3">
        {accounts.map((account) => {
          ...
          return (
            <div
              key={account.id}
              className="rounded-2xl border border-border bg-background-muted/40 px-4 py-3 text-xs"
            >
              <div className={isMobile ? 'grid gap-3' : 'flex flex-wrap items-center justify-between gap-3'}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-full border border-transparent bg-background-muted/50 px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.2em] text-foreground-muted transition hover:text-error disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Remove
                  </button>
                </div>
