  ...
  return (
    <PageTransition>
      <DashboardView
        ...
        onManualSync={dashboard?.onManualSync}
  ...
  return (
    <PageTransition>
      <TransactionsView
        ...
        onDelete={activity?.handleDelete}
        onRestore={activity?.handleRestore}
        activeRange={activity?.activeRange}
        dateRangeMode={activity?.dateRangeMode}
        rangeShortLabel={activity?.rangeShortLabel}
  ...
  return (
    <PageTransition>
      <SettingsView
        ...
        onManualSync={syncPayload?.handleManualSync}
        syncState={syncPayload?.syncState}
        isOnline={syncPayload?.isOnline}
