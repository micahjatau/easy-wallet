...
const SnapshotCard = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-[36px] bg-gradient-to-br from-background via-background-elevated to-background-muted/50 p-8 text-foreground shadow-2xl shadow-black/10 dark:shadow-black/40">
      <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-foreground/5 blur-3xl" />
      <div className="absolute -bottom-20 -left-20 h-56 w-56 rounded-full bg-foreground/5 blur-3xl" />
      
      {/* Subtle grid pattern overlay */}
      <div 
        className="absolute inset-0 opacity-[0.03]"
        style={{
           backgroundImage: `linear-gradient(to right, rgba(15, 23, 42, 0.5) 1px, transparent 1px),
      ...
      <div className="relative z-10 flex flex-col gap-6">
        <div className="flex items-center justify-between">
          ...
          <span className="rounded-full bg-foreground/10 px-4 py-2 text-[9px] font-semibold uppercase tracking-[0.3em] text-foreground">
            {rangeLabel}
          </span>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="font-display text-5xl leading-[0.95] tracking-tight text-foreground md:text-6xl">
